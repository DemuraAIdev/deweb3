...
export default function NowPlaying() {
  ...
  return (
    <div className="rounded-lg border-2 border-gray-700 bg-gray-200 p-4 transition  duration-500 hover:scale-[1.05] hover:border-spotify-green  dark:bg-[#111010] dark:hover:bg-gray-800">
